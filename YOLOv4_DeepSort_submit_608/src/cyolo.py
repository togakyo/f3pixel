...
class CYOLO(object):
    def __init__(self):
        self.model_path = '../model/yolo-obj_car_2class_1800.h5'
        self.anchors_path = '../model/cyolo_anchors.txt'
        self.classes_path = '../model/cyolo_class.txt'
        self.gpu_num = 1
    ...
    def detect_image(self, image, cl_predstr):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if predicted_class != (cl_predstr):  # Modify to detect other classes.
                continue
            box = out_boxes[i]
            score = out_scores[i]
            x = int(box[1])
