...
def yolo_head(feats, anchors, num_classes, input_shape, calc_loss=False):
    ...
    box_xy = (K.sigmoid(feats[..., :2]) + grid) / K.cast(grid_shape[...,::-1], K.dtype(feats))#changed code 20200505
    box_wh = K.exp(feats[..., 2:4]) * anchors_tensor / K.cast(input_shape[...,::-1], K.dtype(feats))#changed code 20200505
